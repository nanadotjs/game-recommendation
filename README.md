...
O sistema criado pela desenvolvedora é uma plataforma online para computadores, celulares e tablets que sugere aleatoriamente uma recomendação de jogo digital conforme: gênero, plataforma e/ou RAM informado.
...
1. Após clonar o projeto no terminal instale as dependências com npm install ou yarn 
2. No root do projeto crie o arquivo .env e cole a api na variável "VITE_API_URL"
3. Inicie o servidor com npm run dev ou yarn run dev
